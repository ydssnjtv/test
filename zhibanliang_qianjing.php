...
echo "<p style='color:black;font-size:35px;text-align:center;'>成功构造Mopaas Mysql数据库连接！<br/></p>";
...
echo "<p style='color:red;font-size:35px;text-align:center;'>你选择的时间是：".$year.'年'.$month.'月<br/></p>';
panduan($time);
//具体查询和结果显示
