<table border="1" align="center">
 <tr>
  <th><span style='color:black;font-size:30px'>姓名</span></th>
  <th><span style='color:black;font-size:30px'>吴锦夏</span></th>
  <th><span style='color:black;font-size:30px'>胡守霞</span></th>
  <th><span style='color:black;font-size:30px'>徐艳</span></th>
  <th><span style='color:black;font-size:30px'>孙海燕</span></th>
  <th><span style='color:black;font-size:30px'>郑雯</span></th>
  <th><span style='color:black;font-size:30px'>杨芮</span></th>
  <th><span style='color:black;font-size:30px'>钱静</span></th>
  <th><span style='color:black;font-size:30px'>杨旸</span></th>
  <th><span style='color:black;font-size:30px'>李笑啡</span></th>
 </tr>
<?php
...
echo "<p style='color:red;font-size:30px;text-align:center;'>成功构造Mopaas Mysql数据库连接！<br/></p>";
...
echo "<p style='color:red;font-size:30px;text-align:center;'>你选择的时间是：".$year.'年'.$month.'月<br/></p>';
panduan($time);
//具体查询和结果显示
...
echo "<tr><td><p style='color:black;font-size:30px;text-align:center'>早班</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
  ...
  $count=mysql_fetch_row($aa);
   echo "<td><p style='color:black;font-size:30px;text-align:center'>".$count[0]."</p></td>";
...
echo "<tr><td><p style='color:black;font-size:30px;text-align:center'>中班</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
...
echo "<tr><td><p style='color:black;font-size:30px;text-align:center'>中二</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
...
echo "<tr><td><p style='color:black;font-size:30px;text-align:center'>小晚</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
...
echo "<tr><td><p style='color:black;font-size:30px;text-align:center'>审晚</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
...
echo "<tr><td><p style='color:black;font-size:30px;text-align:center'>收带</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
...
echo "<tr><td><p style='color:black;font-size:30px;text-align:center;font-weight:bold'>合计</p></td>";
$i=0;
foreach($summary as $cc=>$vv){
    echo "<td><p style='color:black;font-size:30px;text-align:center;font-weight:bold'>".$vv."</p></td>";
	if($i==8){echo "</tr>";}
   $i++;
}
