<table border="1" align="center">
 <tr>
  <th><span style='color:black;font-size:32px'>姓名</span></th>
  <th><span style='color:black;font-size:32px'>吴锦夏</span></th>
  <th><span style='color:black;font-size:32px'>胡守霞</span></th>
  <th><span style='color:black;font-size:32px'>徐艳</span></th>
  <th><span style='color:black;font-size:32px'>孙海燕</span></th>
  <th><span style='color:black;font-size:32px'>郑雯</span></th>
  <th><span style='color:black;font-size:32px'>杨芮</span></th>
  <th><span style='color:black;font-size:32px'>钱静</span></th>
  <th><span style='color:black;font-size:32px'>杨旸</span></th>
  <th><span style='color:black;font-size:32px'>李笑啡</span></th>
 </tr>
<?php
...
echo "<tr><td><p style='color:black;font-size:32px;text-align:center'>早班</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
  ...
  $count=mysql_fetch_row($aa);
   echo "<td><p style='color:black;font-size:32px;text-align:center'>".$count[0]."</p></td>";
...
echo "<tr><td><p style='color:black;font-size:32px;text-align:center'>中班</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
...
echo "<tr><td><p style='color:black;font-size:32px;text-align:center'>中二</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
...
echo "<tr><td><p style='color:black;font-size:32px;text-align:center'>小晚</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
...
echo "<tr><td><p style='color:black;font-size:32px;text-align:center'>审晚</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
...
echo "<tr><td><p style='color:black;font-size:32px;text-align:center'>收带</p></td>";
$i=0;
while($i<=8){
  $ry=$renyuan[$i];
...
echo "<tr><td><p style='color:black;font-size:32px;text-align:center;font-weight:bold'>合计</p></td>";
$i=0;
foreach($summary as $cc=>$vv){
    echo "<td><p style='color:black;font-size:32px;text-align:center;font-weight:bold'>".$vv."</p></td>";
	if($i==8){echo "</tr>";}
   $i++;
}
